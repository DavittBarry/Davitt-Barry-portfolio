...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220525_davittbarry_bf2e810147654a529655_20220815090919_archive.zip';
	const ARCHIVE_SIZE		 = '533347866';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bf2e810-15090919';
    const SECONDARY_PACKAGE_HASH = 'd15e6f8-15090919';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.7.1==');
		self::log('----------------------------------------------------');
