<?php
	...
	$advance_portfolio_loader_background_color_settings = get_theme_mod('advance_portfolio_loader_background_color_settings');
	$advance_portfolio_custom_css .='#loader-wrapper .loader-section{';
		$advance_portfolio_custom_css .='background-color: '.esc_attr($advance_portfolio_loader_background_color_settings).';';
	$advance_portfolio_custom_css .='} ';

	// fixed header padding option
	$advance_portfolio_sticky_header_padding_settings = get_theme_mod('advance_portfolio_sticky_header_padding_settings');
	$advance_portfolio_custom_css .='.page-template-custom-front-page .fixed-header #header{';
		$advance_portfolio_custom_css .='padding: '.esc_attr($advance_portfolio_sticky_header_padding_settings).'px !important;';
	$advance_portfolio_custom_css .='}';
	$advance_portfolio_custom_css .='.page-template-custom-front-page .fixed-header{';
		$advance_portfolio_custom_css .='padding: 0 !important;';
	$advance_portfolio_custom_css .='}';
	$advance_portfolio_custom_css .='.fixed-header{';
		$advance_portfolio_custom_css .='padding: '.esc_attr($advance_portfolio_sticky_header_padding_settings).'px !important;';
	$advance_portfolio_custom_css .='}';
	...
	$advance_portfolio_products_navigation = get_theme_mod('advance_portfolio_products_navigation', 'Yes');
	if($advance_portfolio_products_navigation == 'No'){
		$advance_portfolio_custom_css .='.woocommerce nav.woocommerce-pagination{';
			$advance_portfolio_custom_css .='display: none;';
		$advance_portfolio_custom_css .='}';
	}

	// featured image setting
	$advance_portfolio_featured_img_border_radius = get_theme_mod('advance_portfolio_featured_img_border_radius', 0);
	$advance_portfolio_custom_css .='.our-services img, .feature-box img{';
		$advance_portfolio_custom_css .='border-radius: '.esc_attr($advance_portfolio_featured_img_border_radius).'px;';
	$advance_portfolio_custom_css .='}';

	$advance_portfolio_featured_img_box_shadow = get_theme_mod('advance_portfolio_featured_img_box_shadow',0);
	$advance_portfolio_custom_css .='.our-services img, .feature-box img{';
		$advance_portfolio_custom_css .='box-shadow: '.esc_attr($advance_portfolio_featured_img_box_shadow).'px '.esc_attr($advance_portfolio_featured_img_box_shadow).'px '.esc_attr($advance_portfolio_featured_img_box_shadow).'px #ccc;';
	$advance_portfolio_custom_css .='}';

	// slider top and bottom padding
	$advance_portfolio_top_bottom_banner_content_space = get_theme_mod('advance_portfolio_top_bottom_banner_content_space');
	$advance_portfolio_left_right_banner_content_space = get_theme_mod('advance_portfolio_left_right_banner_content_space');
	$advance_portfolio_custom_css .='#banner .box-content, #banner h1, #banner p, #banner .social-media{';
		$advance_portfolio_custom_css .='top: '.esc_attr($advance_portfolio_top_bottom_banner_content_space).'%; bottom: '.esc_attr($advance_portfolio_top_bottom_banner_content_space).'%;left: '.esc_attr($advance_portfolio_left_right_banner_content_space).'%;right: '.esc_attr($advance_portfolio_left_right_banner_content_space).'%;';
	$advance_portfolio_custom_css .='}';