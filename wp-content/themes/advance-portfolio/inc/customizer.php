...
function advance_portfolio_customize_register($wp_customize) {
	...
	$advance_portfolio_font_array = array(
        '' => 'No Fonts',
	...
	$wp_customize->add_control(
	    ...
	    'type'     => 'select',
	    'choices'  => $advance_portfolio_font_array,
	));
	...
	$wp_customize->add_setting('advance_portfolio_products_navigation',array(
       'default' => 'Yes',
       'sanitize_callback'	=> 'advance_portfolio_sanitize_choices'
    ));
    $wp_customize->add_control('advance_portfolio_products_navigation',array(
       'type' => 'radio',
       'label' => __('Woocommerce Products Navigation','advance-portfolio'),
       'choices' => array(
            'Yes' => __('Yes','advance-portfolio'),
            'No' => __('No','advance-portfolio'),
        ),
       'section' => 'woocommerce_product_catalog',
    ));
	...
	$wp_customize->add_section('advance_portfolio_product_sale_section', array(
		'title'    => __('Product Sale Button Settings', 'advance-portfolio'),
		'priority' => null,
		'panel'    => 'woocommerce',
	));

	$wp_customize->add_setting('advance_portfolio_align_product_sale',array(
        'default' => 'Right',
        'sanitize_callback' => 'advance_portfolio_sanitize_choices'
	));
	$wp_customize->add_control('advance_portfolio_align_product_sale',array(
        'type' => 'radio',
        'label' => __('Product Sale Button Alignment','advance-portfolio'),
        'section' => 'advance_portfolio_product_sale_section',
        'choices' => array(
	...
	$wp_customize->add_setting( 'advance_portfolio_border_radius_product_sale',array(
		'default' => 50,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	));
	$wp_customize->add_control('advance_portfolio_border_radius_product_sale', array(
        'label'  => __('Product Sale Button Border Radius','advance-portfolio'),
        'section'  => 'advance_portfolio_product_sale_section',
        'type'        => 'number',
        'input_attrs' => array(
        	'step'=> 1,
	...
	$wp_customize->add_setting('advance_portfolio_product_sale_font_size',array(
		'default'=> 14,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float'
	));
	$wp_customize->add_control('advance_portfolio_product_sale_font_size',array(
		'label'	=> __('Product Sale Button Font Size','advance-portfolio'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_section( 'advance_portfolio_theme_color_option',array( 
		'panel' => 'advance_portfolio_panel_id',
		'title' => esc_html__( 'Theme Color Option', 'advance-portfolio' ) )
	);
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_portfolio_theme_color_first', array(
  		'label' => __('First Color Option', 'advance-portfolio'),
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_portfolio_theme_color_second', array(
  		'label' => __('Second Color Option', 'advance-portfolio'),
  		'description' => __('One can change complete theme color on just one click.', 'advance-portfolio'),
	    'section' => 'advance_portfolio_theme_color_option',
    ...
    $wp_customize->add_setting( 'advance_portfolio_loader_background_color_settings', array(
	    'default' => '#222',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_portfolio_loader_background_color_settings', array(
  		'label' => __('Preloader Background Color', 'advance-portfolio'),
	    'section' => 'advance_portfolio_left_right',
	    'settings' => 'advance_portfolio_loader_background_color_settings',
  	)));
    ...
    $wp_customize->add_setting( 'advance_portfolio_sticky_header_padding_settings', array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	) );
	$wp_customize->add_control( 'advance_portfolio_sticky_header_padding_settings', array(
		'label'       => esc_html__( 'Sticky Header Padding','advance-portfolio' ),
		'section'     => 'advance_portfolio_left_right',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('advance_portfolio_banner_title_Show_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_banner_title_Show_hide',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Banner Title','advance-portfolio'),
       'section' => 'advance_portfolio_banner'
    ));

    $wp_customize->add_setting('advance_portfolio_banner_content_Show_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_banner_content_Show_hide',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Banner Content','advance-portfolio'),
       'section' => 'advance_portfolio_banner'
    ));
	...
	$wp_customize->add_setting('advance_portfolio_banner_overlay',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_banner_overlay',array(
       'type' => 'checkbox',
       'label' => __('Home Page Banner Overlay','advance-portfolio'),
		'description'    => __('This option will add colors over the slider.','advance-portfolio'),
       'section' => 'advance_portfolio_banner'
    ));

    $wp_customize->add_setting('advance_portfolio_banner_image_overlay_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'advance_portfolio_banner_image_overlay_color', array(
		'label'    => __('Home Page Banner Overlay Color', 'advance-portfolio'),
		'section'  => 'advance_portfolio_banner',
		'description'    => __('It will add the color overlay of the slider. To make it transparent, use the below option.','advance-portfolio'),
		'settings' => 'advance_portfolio_banner_image_overlay_color',
	)));
	...
	$wp_customize->add_setting('advance_portfolio_top_bottom_banner_content_space',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	));
	$wp_customize->add_control('advance_portfolio_top_bottom_banner_content_space',array(
		'label'	=> __('Top Bottom Banner Content Space','advance-portfolio'),
		'section'=> 'advance_portfolio_banner',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('advance_portfolio_left_right_banner_content_space',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	));
	$wp_customize->add_control('advance_portfolio_left_right_banner_content_space',array(
		'label'	=> __('Left Right Banner Content Space','advance-portfolio'),
		'section'=> 'advance_portfolio_banner',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
    ...
    $wp_customize->add_control('advance_portfolio_responsive_scroll',array(
       'type' => 'checkbox',
       'label' => __('Scroll To Top','advance-portfolio'),
       'section' => 'advance_portfolio_responsive_setting'
    ));
    ...
    $wp_customize->add_control('advance_portfolio_responsive_preloader',array(
       'type' => 'checkbox',
       'label' => __('Preloader','advance-portfolio'),
       'section' => 'advance_portfolio_responsive_setting'
    ));
    ...
    $wp_customize->add_setting('advance_portfolio_show_featured_image_post',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_show_featured_image_post',array(
       'type' => 'checkbox',
       'label' => __('Blog Post Image','advance-portfolio'),
       'section' => 'advance_portfolio_blog_post'
    ));

    $wp_customize->add_setting('advance_portfolio_time_hide',array(
       'default' => false,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_time_hide',array(
       'type' => 'checkbox',
       'label' => __('Time','advance-portfolio'),
       'section' => 'advance_portfolio_blog_post'
    ));
    ...
    $wp_customize->add_setting( 'advance_portfolio_featured_img_border_radius', array(
		'default'=> 0,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	) );
	$wp_customize->add_control( 'advance_portfolio_featured_img_border_radius', array(
		'label'       => esc_html__( 'Blog Post Image Border Radius','advance-portfolio' ),
		'section'     => 'advance_portfolio_blog_post',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'advance_portfolio_featured_img_box_shadow',array(
		'default' => 0,
		'sanitize_callback'    => 'advance_portfolio_sanitize_float',
	));
	$wp_customize->add_control('advance_portfolio_featured_img_box_shadow',array(
		'label' => esc_html__( 'Blog Post Image Shadow','advance-portfolio' ),
		'section' => 'advance_portfolio_blog_post',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
	...
	$wp_customize->add_setting('advance_portfolio_blog_post_pagination',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_portfolio_blog_post_pagination',array(
       'type' => 'checkbox',
       'label' => __('Pagination in Blog Page','advance-portfolio'),
       'section' => 'advance_portfolio_blog_post'
    ));

    $wp_customize->add_setting( 'advance_portfolio_show_related_post',array(
		'default' => true,
      	'sanitize_callback'	=> 'advance_portfolio_sanitize_checkbox'
    ) );
    $wp_customize->add_control('advance_portfolio_show_related_post',array(
    	'type' => 'checkbox',
        'label' => __( 'Related Post','advance-portfolio' ),
        'section' => 'advance_portfolio_blog_post'
    ));

    $wp_customize->add_setting('advance_portfolio_related_posts_taxanomies_options',array(
        'default' => 'categories',
        'sanitize_callback' => 'advance_portfolio_sanitize_choices'
	));
	$wp_customize->add_control('advance_portfolio_related_posts_taxanomies_options',array(
        'type' => 'radio',
        'label' => __('Related Post Taxonomies','advance-portfolio'),
        'section' => 'advance_portfolio_blog_post',
        'choices' => array(
            'categories' => __('Categories','advance-portfolio'),
            'tags' => __('Tags','advance-portfolio'),
        ),
	) );

	$wp_customize->add_setting('advance_portfolio_related_post_title',array(
		'default'=> __('Related Posts','advance-portfolio'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_portfolio_related_post_title',array(
		'label'	=> __('Related Post Title','advance-portfolio'),
		'section'=> 'advance_portfolio_blog_post',
		'type'=> 'text'
	));

   	$wp_customize->add_setting('advance_portfolio_related_posts_number',array(
		'default'=> 3,
		'sanitize_callback'	=> 'advance_portfolio_sanitize_float',
	));
	$wp_customize->add_control('advance_portfolio_related_posts_number',array(
		'label'	=> __('Related Post Number','advance-portfolio'),
		'section'=> 'advance_portfolio_blog_post',
		'type'=> 'number',
		'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('advance_portfolio_footer_widget_bg_color', array(
		'default'           => '',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'advance_portfolio_footer_widget_bg_color', array(
		'label'    => __('Footer Widget Background Color', 'advance-portfolio'),
		'section'  => 'advance_portfolio_footer_section',
	)));

	$wp_customize->add_setting('advance_portfolio_footer_widget_bg_image',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'advance_portfolio_footer_widget_bg_image',array(
        'label' => __('Footer Widget Background Image','advance-portfolio'),
        'section' => 'advance_portfolio_footer_section'
	)));
	...
	$wp_customize->add_setting('advance_portfolio_copyright_content_align',array(
        'default' => 'center',
        'sanitize_callback' => 'advance_portfolio_sanitize_choices'
	));
	$wp_customize->add_control('advance_portfolio_copyright_content_align',array(
        'type' => 'select',
        'label' => __('Copyright Text Alignment ','advance-portfolio'),
        'section' => 'advance_portfolio_footer_section',
        'choices' => array(
            'left' => __('Left','advance-portfolio'),
            'right' => __('Right','advance-portfolio'),
...
final class Advance_Portfolio_Customize {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script('advance-portfolio-customize-controls', trailingslashit(esc_url(get_template_directory_uri())).'/js/customize-controls.js', array('customize-controls'));

		wp_enqueue_style('advance-portfolio-customize-controls', trailingslashit(esc_url(get_template_directory_uri())).'/css/customize-controls.css');
	}
}
